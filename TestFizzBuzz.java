public class TestFizzBuzz {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tester.fizzBuzz(9,"Fizz","Buzz","FizzBuzz"));     // Fizz
        System.out.println(tester.fizzBuzz(10,"Fizz","Buzz","FizzBuzz"));    // Buzz
        System.out.println(tester.fizzBuzz(15,"Fizz","Buzz","FizzBuzz"));    // FizzBuzz
        System.out.println(tester.fizzBuzz(16,"Fizz","Buzz","FizzBuzz"));    // 16
        System.out.println(tester.fizzBuzz(2,"Fizz","Buzz","FizzBuzz"));     // 2
